                ...
                <div className='flex justify-between items-center p-2'>
                    ...
                    <ul className='flex'>
                        {!session ? (
                            ...
                            (
                                <>
                                    {(session?.user?.role === "admin") && <li className='transition-all mx-3 py-1 hover:ease-in hover:text-blue-800 hover:bg-blue-300 border-blue-100 bg-blue-500 text-white px-2 rounded-md cursor-pointer'>
                                        <Link href="/admin">Admin Dashboard</Link>
                                    </li>}

                                    {(session?.user?.role === "user") && <li className='transition-all mx-3 py-1 hover:ease-in hover:text-blue-800 hover:bg-blue-300 border-blue-100 bg-blue-500 text-white px-2 rounded-md cursor-pointer'>
                                        <Link href="/Welcome">All Feeds</Link>
                                    </li>}
